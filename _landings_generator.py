...
/* NAV */
nav{position:fixed;top:0;left:0;right:0;z-index:100;padding:10px 24px;display:flex;align-items:center;justify-content:space-between;transition:all .4s}
nav.s{background:rgba(247,246,243,.92);backdrop-filter:blur(20px);padding:8px 24px}
.nav-logo{height:44px;width:auto;transition:all .4s}
nav.s .nav-logo{height:38px}
...
@media(min-width:900px){.nk{display:flex}.nh{display:none}nav{padding:12px 40px}nav.s{padding:8px 40px}}
...
<footer>
  <div class="fi">
    <div class="fgr">
      ...
      <div><div class="ft">Contacto</div><ul class="flk"><li><a href="https://wa.me/5491126952459" target="_blank">WhatsApp</a></li><li><a href="#">Email: A confirmar</a></li></ul></div>
    </div>
